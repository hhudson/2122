...
CREATE TABLE  "BLOG_ARTICLE" 
   (	"ARTICLE_ID" NUMBER(38,0) NOT NULL ENABLE, 
	...
	"CHANGED_BY" VARCHAR2(80 CHAR) NOT NULL ENABLE, 
	"AUTHOR_ID" NUMBER(38,0) NOT NULL ENABLE, 
	"ACTIVE" VARCHAR2(1) DEFAULT 'N' NOT NULL ENABLE, 
	"CATEGORY_ID" NUMBER(38,0) NOT NULL ENABLE, 
	...
	"KEYWORDS" VARCHAR2(256 CHAR) NOT NULL ENABLE, 
	"HASTAGS" VARCHAR2(256 CHAR), 
	"PAGE_NO" NUMBER DEFAULT 1 NOT NULL ENABLE, 
	"BANNER_IMAGE" VARCHAR2(500) DEFAULT '2122card.png' NOT NULL ENABLE, 
	 ...
	 CONSTRAINT "BLOG_ARTICLE_PK" PRIMARY KEY ("ARTICLE_ID")
  USING INDEX  ENABLE
   )
/
