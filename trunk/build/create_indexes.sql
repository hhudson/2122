CREATE INDEX  "BLOG_PAGE_CTX" ON  "BLOG_PAGE" ("PAGE_TEXT") 
INDEXTYPE IS "CTXSYS"."CONTEXT"  PARAMETERS ('FILTER CTXSYS.NULL_FILTER SECTION GROUP CTXSYS.HTML_SECTION_GROUP SYNC (ON COMMIT)')
/
CREATE INDEX  "BLOG_PAGE_IDX1" ON  "BLOG_PAGE" ("AUTHOR_ID")
/
CREATE INDEX  "BLOG_PAGE_IDX2" ON  "BLOG_PAGE" ("CATEGORY_ID")
/
CREATE INDEX  "BLOG_PAGE_IDX3" ON  "BLOG_PAGE" ("ACTIVE")
/
CREATE INDEX  "BLOG_PAGE_IDX4" ON  "BLOG_PAGE" ("YEAR_MONTH_NUM")
/
CREATE INDEX  "BLOG_PAGE_IDX5" ON  "BLOG_PAGE" ("CREATED_ON")
/
CREATE INDEX  "BLOG_PAGE_IDX6" ON  "BLOG_PAGE" ("VALID_FROM")
/
