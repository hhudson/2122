...
/
CREATE TABLE  BLOG_PAGE_LOG
(    PAGE_ID NUMBER(38,0) NOT NULL ENABLE,
VIEW_COUNT NUMBER(38,0) DEFAULT 0 NOT NULL ENABLE,
PAGE_RATE NUMBER DEFAULT 0 NOT NULL ENABLE,
PAGE_RATE_INT NUMBER(1,0) DEFAULT 0 NOT NULL ENABLE,
RATE_CLICK NUMBER(38,0) DEFAULT 0 NOT NULL ENABLE,
LAST_VIEW DATE,
LAST_RATE DATE,
CONSTRAINT BLOG_PAGE_LOG_PK PRIMARY KEY (PAGE_ID) ENABLE,
CONSTRAINT BLOG_PAGE_LOG_CK1 CHECK (PAGE_ID > 0) ENABLE,
CONSTRAINT BLOG_PAGE_LOG_CK2 CHECK (VIEW_COUNT >= 0) ENABLE,
CONSTRAINT BLOG_PAGE_LOG_CK3 CHECK (PAGE_RATE BETWEEN 0 AND 5) ENABLE,
CONSTRAINT BLOG_PAGE_LOG_CK4 CHECK (PAGE_RATE_INT BETWEEN 0 AND 5) ENABLE,
CONSTRAINT BLOG_PAGE_LOG_CK5 CHECK (RATE_CLICK >= 0) ENABLE
)
/
CREATE TABLE  BLOG_PAGE_PREVIEW
(    APEX_SESSION_ID NUMBER(38,0) NOT NULL ENABLE,
AUTHOR_ID NUMBER(38,0),
CATEGORY_ID NUMBER(38,0),
PAGE_TITLE VARCHAR2(256 CHAR),
PAGE_TEXT CLOB,
CONSTRAINT BLOG_PAGE_PREVIEW_PK PRIMARY KEY (APEX_SESSION_ID) ENABLE
)
/
...
CONSTRAINT BLOG_COMMENT_CK3 CHECK (PAGE_ID > 0) ENABLE,
...
CONSTRAINT BLOG_COMMENT_NOTIFY_PK PRIMARY KEY (PAGE_ID, USER_ID) ENABLE,
CONSTRAINT BLOG_COMMENT_NOTIFY_CK1 CHECK (PAGE_ID > 0) ENABLE,
...
CONSTRAINT BLOG_HTTP410_CK1 CHECK (ID_SOURCE IN('PAGE','CATEGORY','FILE')) ENABLE
)
/